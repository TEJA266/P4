...
<html lang="en">
    ...
    <html>
    <head>
        <title>HomeNest: Seller dashboard</title>
    ...
    <body>
        ...
        <br>
        <p style="text-align: center; font-size: 30px;position: absolute; left: 43%; top: 150px; color: red;">Welcome, Seller!</p>
    <div class="full">
        <div style="margin-left: 10% ;"></div>
       <?php
// connect to the database
$pdo = new PDO('mysql:host=localhost;dbname=nmaguluri1', 'nmaguluri1', 'nmaguluri1');
